...
def create_regions(world):
    ...
    world.regions = [
        create_ow_region('Kokiri Forest', ['Kokiri Sword Chest', 'GS Kokiri Know It All House', 'GS Kokiri Bean Patch', 'GS Kokiri House of Twins'], ['Links House', 'Mido House', 'Saria House', 'House of Twins', 'Know It All House', 'Kokiri Shop', 'Deku Tree', 'Lost Woods', 'Lost Woods Bridge', 'Kokiri Forest Storms Grotto'], hintName='Kokiri Forest'),
        ...
        create_interior_region('Mido House', ['Mido Chest Top Left', 'Mido Chest Top Right', 'Mido Chest Bottom Left', 'Mido Chest Bottom Right'], ['Mido House Exit'], hintName='Kokiri Forest'),
        create_interior_region('Saria House', None, ['Saria House Exit'], hintName='Kokiri Forest'),
        create_interior_region('House of Twins', None, ['House of Twins Exit'], hintName='Kokiri Forest'),
        create_interior_region('Know It All House', None, ['Know It All House Exit'], hintName='Kokiri Forest'),
        create_interior_region('Kokiri Shop', None, ['Kokiri Shop Exit'], hintName='Kokiri Forest'),
        create_dungeon_region('Deku Tree Lobby', ['Deku Tree Lobby Chest', 'Deku Tree Compass Chest', 'Deku Tree Compass Room Side Chest', 'Deku Tree Basement Chest', 'GS Deku Tree Compass Room', 'GS Deku Tree Basement Vines', 'GS Deku Tree Basement Gate'], ['Deku Tree Exit', 'Deku Tree Slingshot Passage', 'Deku Tree Basement Path']),
        ...
        create_ow_region('Lost Woods', ['Skull Kid', 'Ocarina Memory Game', 'Target in Woods', 'Deku Salesman Woods', 'GS Lost Woods Bean Patch Near Bridge', 'GS Lost Woods Bean Patch Near Stage'], ['Lost Woods Front', 'Meadow Entrance', 'Woods to Goron City', 'Lost Woods Dive Warp', 'Adult Meadow Access', 'Lost Woods Generic Grotto', 'Deku Theater', 'Lost Woods Sales Grotto'], hintName='Lost Woods'),
        create_ow_region('Sacred Forest Meadow Entryway', None, ['Meadow Exit', 'Meadow Gate', 'Front of Meadow Grotto'], hintName='Sacred Forest Meadow'),
        create_ow_region('Sacred Forest Meadow', ['Song from Saria'], ['Meadow Gate Exit', 'Meadow Fairy Grotto'], hintName='Sacred Forest Meadow'),
        create_ow_region('Lost Woods Bridge', ['Gift from Saria'], ['Kokiri Forest Entrance', 'Forest Exit'], hintName='Lost Woods'),
        create_ow_region('Hyrule Field', ['Ocarina of Time', 'Song from Ocarina of Time'], ['Field to Forest', 'Field to Lake', 'Field to Valley', 'Field to Castle Town', 'Field to Kakariko', 'Field to Zora River', 'Lon Lon Rance Entrance',
                                                     ...
                                                     'Field Far West Castle Town Grotto', 'Field Kakariko Grotto', 'Field North Lon Lon Grotto'], hintName='Hyrule Field'),
        create_ow_region('Lake Hylia', ['Underwater Bottle', 'Lake Hylia Sun', 'Lake Hylia Freestanding PoH', 'GS Lake Hylia Bean Patch', 'GS Lake Hylia Lab Wall', 'GS Lake Hylia Small Island', 'GS Lake Hylia Giant Tree'], ['Lake Exit', 'Lake Hylia Dive Warp', 'Lake Hylia Lab', 'Fishing Hole', 'Water Temple Entrance', 'Lake Hylia Grotto'], hintName='Lake Hylia'),
        create_interior_region('Lake Hylia Lab', ['Diving in the Lab', 'GS Lab Underwater Crate'], hintName='Lake Hylia'),
        create_interior_region('Fishing Hole', ['Child Fishing', 'Adult Fishing'], hintName='Lake Hylia'),
        create_dungeon_region('Water Temple Lobby', ['Water Temple Map Chest', 'Water Temple Compass Chest', 'Water Temple Torches Chest', 'Water Temple Dragon Chest', 'Water Temple Central Bow Target Chest', 'Water Temple Boss Key Chest', 'Morpha Heart', 'Morpha', 'GS Water Temple South Basement', 'GS Water Temple Near Boss Key Chest'], ['Water Temple Exit', 'Water Temple Central Pillar', 'Water Temple Upper Locked Door']),
        create_dungeon_region('Water Temple Middle Water Level', ['Water Temple Central Pillar Chest', 'Water Temple Cracked Wall Chest', 'GS Water Temple Falling Platform Room']),
        create_dungeon_region('Water Temple Dark Link Region', ['Water Temple Dark Link Chest', 'Water Temple River Chest', 'GS Water Temple Serpent River', 'GS Water Temple Central Room']),
        create_ow_region('Gerudo Valley', ['Gerudo Valley Waterfall Freestanding PoH', 'Gerudo Valley Crate Freestanding PoH', 'GS Gerudo Valley Small Bridge', 'GS Gerudo Valley Bean Patch'], ['Valley Exit', 'Valley River', 'Bridge Crossing'], hintName='Gerudo Valley'),
        create_ow_region('Gerudo Valley Far Side', ['Gerudo Valley Hammer Rocks Chest', 'GS Gerudo Valley Behind Tent', 'GS Gerudo Valley Pillar'], ['Fortress Entrance'], hintName='Gerudo Valley'),
        create_ow_region('Gerudo Fortress', ['Gerudo Fortress Rooftop Chest', 'Horseback Archery 1000 Points', 'Horseback Archery 1500 Points', 'Gerudo Fortress Carpenter Rescue', 'GS Gerudo Fortress Archery Range', 'GS Gerudo Fortress Top Floor'], ['Haunted Wasteland Entrance', 'Gerudo Training Grounds Entrance'], hintName='Gerudo Fortress'),
        create_ow_region('Haunted Wasteland', ['Haunted Wasteland Structure Chest', 'GS Wasteland Ruins'], ['Haunted Wasteland Crossing'], hintName='Haunted Wasteland'),
        create_ow_region('Desert Colossus', ['Colossus Freestanding PoH', 'Sheik at Colossus', 'GS Desert Colossus Bean Patch', 'GS Desert Colossus Tree', 'GS Desert Colossus Hill'], ['Colossus Fairy', 'Spirit Temple Entrance'], hintName='Desert Colossus'),
        create_interior_region('Colossus Fairy', ['Desert Colossus Fairy Reward'], hintName='Desert Colossus'),
        ...
        create_dungeon_region('Child Spirit Temple', ['Spirit Temple Child Left Chest', 'Spirit Temple Child Right Chest', 'GS Spirit Temple Metal Fence'], ['Child Spirit Temple Passthrough']),
        create_dungeon_region('Early Adult Spirit Temple', ['Spirit Temple Compass Chest', 'Spirit Temple Early Adult Right Chest', 'Spirit Temple First Mirror Right Chest', 'Spirit Temple First Mirror Left Chest', 'GS Spirit Temple Boulder Room'], ['Adult Spirit Temple Passthrough']),
        create_dungeon_region('Spirit Temple Central Chamber', ['Spirit Temple Map Chest', 'Spirit Temple Child Climb East Chest', 'Spirit Temple Child Climb North Chest', 'Spirit Temple Sun Block Room Chest', 'Spirit Temple Statue Hand Chest', 'Spirit Temple NE Main Room Chest', 'GS Spirit Temple Bomb for Light Room', 'GS Spirit Temple Hall to West Iron Knuckle', 'GS Spirit Temple Lobby'], ['Spirit Temple to Hands', 'Spirit Temple Central Locked Door']),
        create_dungeon_region('Spirit Temple Outdoor Hands', ['Silver Gauntlets Chest', 'Mirror Shield Chest'], hintName='Desert Colossus'),
        ...
        create_ow_region('Castle Town', None, ['Castle Town Exit', 'Temple of Time', 'Hyrule Castle Grounds', 'Castle Town Rupee Room', 'Castle Town Bazaar', 'Castle Town Mask Shop', 'Castle Town Shooting Gallery', 'Ganons Castle Grounds',
                                               'Castle Town Bombchu Bowling', 'Castle Town Potion Shop', 'Castle Town Treasure Chest Game', 'Castle Town Bombchu Shop', 'Castle Town Dog Lady', 'Castle Town Man in Green House'], hintName='Market'),
        create_interior_region('Temple of Time', ['Zelda'], ['Temple of Time Exit', 'Door of Time'], hintName='Temple of Time'),
        create_interior_region('Beyond Door of Time', ['Master Sword Pedestal', 'Sheik at Temple'], ['Emerge as Adult'], hintName='Temple of Time'),
        create_ow_region('Hyrule Castle Grounds', ['Malon Egg', 'GS Hyrule Castle Tree'], ['Hyrule Castle Grounds Exit', 'Hyrule Castle Garden', 'Hyrule Castle Fairy', 'Castle Storms Grotto'], hintName='Hyrule Castle'),
        create_ow_region('Hyrule Castle Garden', ['Zeldas Letter', 'Impa at Castle'], ['Hyrule Castle Garden Exit'], hintName='Castle Courtyard'),
        create_interior_region('Hyrule Castle Fairy', ['Hyrule Castle Fairy Reward'], hintName='Hyrule Castle'),
        create_ow_region('Ganons Castle Grounds', ['GS Outside Ganon\'s Castle'], ['Ganons Castle Grounds Exit', 'Ganons Castle Fairy', 'Rainbow Bridge'], hintName='Ganon\'s Castle'),
        create_interior_region('Ganons Castle Fairy', ['Ganons Castle Fairy Reward'], hintName='Ganon\'s Castle'),
        create_interior_region('Castle Town Rupee Room', ['10 Big Poes', 'GS Castle Market Guard House'], hintName='Market'),
        create_interior_region('Castle Town Bazaar', hintName='Market'),
        create_interior_region('Castle Town Mask Shop', hintName='Market'),
        create_interior_region('Castle Town Shooting Gallery', ['Child Shooting Gallery'], hintName='Market'),
        create_interior_region('Castle Town Bombchu Bowling', ['Bombchu Bowling Bomb Bag', 'Bombchu Bowling Piece of Heart'], hintName='Market'),
        create_interior_region('Castle Town Potion Shop', hintName='Market'),
        create_interior_region('Castle Town Treasure Chest Game', ['Treasure Chest Game'], hintName='Market'),
        create_interior_region('Castle Town Bombchu Shop', hintName='Market'),
        create_interior_region('Castle Town Dog Lady', ['Dog Lady'], hintName='Market'),
        create_interior_region('Castle Town Man in Green House', hintName='Market'),
        create_ow_region('Kakariko Village', ['Man on Roof', 'Anju as Adult', 'Anjus Chickens', 'Sheik in Kakariko', 'GS Kakariko House Under Construction', 'GS Kakariko Skulltula House', 'GS Kakariko Guard\'s House', 'GS Kakariko Tree', 'GS Kakariko Watchtower', 'GS Kakariko Above Impa\'s House'], ['Kakariko Exit', 'Carpenter Boss House', 'House of Skulltulla', 'Impas House', 'Impas House Back', 'Windmill', 'Kakariko Bazaar', 'Kakariko Shooting Gallery', 'Bottom of the Well',
                                                                                                'Kakariko Potion Shop Front', 'Kakariko Potion Shop Back', 'Odd Medicine Building', 'Kakariko Bombable Grotto', 'Kakariko Back Grotto', 'Graveyard Entrance', 'Death Mountain Entrance'], hintName='Kakariko Village'),
        create_interior_region('Carpenter Boss House'),
        create_interior_region('House of Skulltulla', ['10 Gold Skulltulla Reward', '20 Gold Skulltulla Reward', '30 Gold Skulltulla Reward', '40 Gold Skulltulla Reward', '50 Gold Skulltulla Reward'], hintName='Kakariko Village'),
        create_interior_region('Impas House', hintName='Kakariko Village'),
        create_interior_region('Impas House Back', ['Impa House Freestanding PoH'], hintName='Kakariko Village'),
        create_interior_region('Windmill', ['Windmill Freestanding PoH', 'Song at Windmill'], hintName='Kakariko Village'),
        create_interior_region('Kakariko Bazaar', hintName='Kakariko Village'),
        create_interior_region('Kakariko Shooting Gallery', ['Adult Shooting Gallery'], hintName='Kakariko Village'),
        create_interior_region('Kakariko Potion Shop Front', hintName='Kakariko Village'),
        create_interior_region('Kakariko Potion Shop Back', hintName='Kakariko Village'),
        create_interior_region('Odd Medicine Building', hintName='Kakariko Village'),
        create_dungeon_region('Bottom of the Well', ['Bottom of the Well Front Left Hidden Wall', 'Bottom of the Well Front Center Bombable', 'Bottom of the Well Right Bottom Hidden Wall', 'Bottom of the Well Center Large Chest', 'Bottom of the Well Center Small Chest', 'Bottom of the Well Back Left Bombable', 'Bottom of the Well Freestanding Key',
                                                     'Bottom of the Well Defeat Boss', 'Bottom of the Well Invisible Chest', 'Bottom of the Well Underwater Front Chest', 'Bottom of the Well Underwater Left Chest', 'Bottom of the Well Basement Chest', 'Bottom of the Well Locked Pits', 'Bottom of the Well Behind Right Grate', 'GS Well West Inner Room', 'GS Well East Inner Room', 'GS Well Like Like Cage'], ['Bottom of the Well Exit']),
        create_ow_region('Graveyard', ['Graveyard Freestanding PoH', 'Gravedigging Tour', 'GS Graveyard Wall', 'GS Graveyard Bean Patch'], ['Shield Grave', 'Composer Grave', 'Heart Piece Grave', 'Dampes Grave', 'Dampes House', 'Graveyard Exit'], hintName='Graveyard'),
        create_interior_region('Shield Grave', ['Shield Grave Chest'], hintName='Graveyard'),
        create_interior_region('Heart Piece Grave', ['Heart Piece Grave Chest'], hintName='Graveyard'),
        create_interior_region('Composer Grave', ['Composer Grave Chest', 'Song from Composer Grave'], hintName='Graveyard'),
        create_interior_region('Dampes Grave', ['Hookshot Chest', 'Dampe Race Freestanding PoH'], hintName='Graveyard'),
        create_interior_region('Dampes House', hintName='Graveyard'),
        create_ow_region('Shadow Temple Warp Region', None, ['Drop to Graveyard', 'Shadow Temple Entrance'], hintName='Graveyard'),
        ...
        create_ow_region('Death Mountain', ['Death Mountain Bombable Chest', 'Biggoron', 'DM Trail Freestanding PoH', 'GS Mountain Trail Bean Patch', 'GS Mountain Trail Bomb Alcove', 'GS Mountain Trail Path to Crater', 'GS Mountain Trail Above Dodongo\'s Cavern'], ['Death Mountain Exit', 'Goron City Entrance', 'Mountain Crater Entrance', 'Mountain Summit Fairy', 'Dodongos Cavern Rocks', 'Mountain Bombable Grotto', 'Mountain Storms Grotto'], hintName='Death Mountain Trail'),
        create_ow_region('Dodongos Cavern Entryway', None, ['Dodongos Cavern', 'Mountain Access from Behind Rock']),
        create_ow_region('Goron City', ['Goron City Leftmost Maze Chest', 'Goron City Left Maze Chest', 'Goron City Right Maze Chest', 'Goron City Pot Freestanding PoH', 'Rolling Goron as Child', 'Link the Goron', 'GS Goron City Boulder Maze', 'GS Goron City Center Platform'], ['Goron City Exit', 'Goron City Bomb Wall', 'Darunias Chamber', 'Crater Access'], hintName='Goron City'),
        create_ow_region('Goron City Woods Warp', None, ['Goron City from Woods', 'Goron City to Woods']),
        create_ow_region('Darunias Chamber', ['Darunias Joy'], ['Darunias Chamber Exit'], hintName='Goron City'),
        create_ow_region('Death Mountain Crater Upper', ['DM Crater Wall Freestanding PoH', 'GS Death Mounter Crater Crate'], ['Crater Exit', 'Crater Hover Boots', 'Crater Scarecrow', 'Top of Crater Grotto'], hintName='Death Mountain Crater'),
        create_ow_region('Death Mountain Crater Lower', None, ['Crater to City', 'Crater Fairy', 'Crater Bridge', 'Crater Ascent'], hintName='Death Mountain Crater'),
        create_ow_region('Death Mountain Crater Central', ['DM Crater Volcano Freestanding PoH', 'Sheik in Crater', 'GS Death Mounter Bean Patch'], ['Crater Bridge Reverse', 'Fire Temple Entrance'], hintName='Death Mountain Crater'),
        create_interior_region('Crater Fairy', ['Crater Fairy Reward'], hintName='Death Mountain Crater'),
        create_interior_region('Mountain Summit Fairy', ['Mountain Summit Fairy Reward'], hintName='Death Mountain Trail'),
        create_dungeon_region('Dodongos Cavern Beginning', None, ['Dodongos Cavern Exit', 'Dodongos Cavern Lobby']),
        create_dungeon_region('Dodongos Cavern Lobby', ['Dodongos Cavern Map Chest', 'Dodongos Cavern Compass Chest', 'GS Dodongo\'s Cavern East Side Room', 'GS Dodongo\'s Cavern Scarecrow'], ['Dodongos Cavern Retreat', 'Dodongos Cavern Left Door']),
        ...
        create_ow_region('Outside Ice Cavern', ['Zoras Fountain Iceberg Freestanding PoH', 'Zoras Fountain Bottom Freestanding PoH', 'GS Zora\'s Fountain Hidden Cave'], ['Ice Cavern Entrance'], hintName='Zora\'s Fountain'),
        create_dungeon_region('Ice Cavern', ['Ice Cavern Map Chest', 'Ice Cavern Compass Chest', 'Ice Cavern Iron Boots Chest', 'Ice Cavern Freestanding PoH', 'Sheik in Ice Cavern', 'GS Ice Cavern Spinning Scythe Room', 'GS Ice Cavern Heart Piece Room', 'GS Ice Cavern Push Block Room'], ['Ice Cavern Exit']),
        create_interior_region('Zora Shop'),
        create_interior_region('Zoras Fountain Fairy', ['Zoras Fountain Fairy Reward'], hintName='Zora\'s Fountain'),
        ...
        create_ow_region('Lon Lon Ranch', ['Epona', 'Song from Malon', 'GS Lon Lon Ranch Tree', 'GS Lon Lon Ranch Rain Shed', 'GS Lon Lon Ranch House Window', 'GS Lon Lon Ranch Back Wall'], ['Lon Lon Exit', 'Talon House', 'Ingo Barn', 'Lon Lon Corner Tower', 'Lon Lon Grotto'], hintName='Lon Lon Ranch'),
        create_interior_region('Talon House', ['Talons Chickens'], hintName='Lon Lon Ranch'),
        create_interior_region('Ingo Barn'),
        create_interior_region('Lon Lon Corner Tower', ['Lon Lon Tower Freestanding PoH'], hintName='Lon Lon Ranch'),
        create_interior_region('Forest Temple Entry Area', ['Sheik Forest Song', 'GS Lost Woods Above Stage', 'GS Sacred Forest Meadow'], ['Adult Meadow Exit', 'Forest Temple Entrance'], hintName='Sacred Forest Meadow'),
        create_dungeon_region('Forest Temple Lobby', ['Forest Temple First Chest', 'Forest Temple Chest Behind Lobby', 'GS Forest Temple First Room', 'GS Forest Temple Lobby'], ['Forest Temple Exit', 'Forest Temple Song of Time Block', 'Forest Temple Lobby Eyeball Switch', 'Forest Temple Lobby Locked Door']),
        ...
        create_grotto_region('Kokiri Forest Storms Grotto', ['Kokiri Forest Storms Grotto Chest'], hintName='Kokiri Forest'),
        create_grotto_region('Lost Woods Generic Grotto', ['Lost Woods Generic Grotto Chest'], hintName='Lost Woods'),
        create_grotto_region('Deku Theater', ['Deku Theater Skull Mask', 'Deku Theater Mask of Truth'], hintName='Lost Woods'),
        create_grotto_region('Lost Woods Sales Grotto', ['Deku Salesman Lost Woods Grotto'], hintName='Lost Woods'),
        create_grotto_region('Meadow Fairy Grotto'),
        create_grotto_region('Front of Meadow Grotto', ['Wolfos Grotto Chest'], hintName='Sacred Forest Meadow'),
        create_grotto_region('Lon Lon Grotto'),
        create_grotto_region('Remote Southern Grotto', ['Remote Southern Grotto Chest'], hintName='Hyrule Field'),
        create_grotto_region('Field Near Lake Outside Fence Grotto', ['Field Near Lake Outside Fence Grotto Chest'], hintName='Hyrule Field'),
        create_grotto_region('Field Near Lake Inside Fence Grotto', ['Deku Salesman Hyrule Field Grotto'], hintName='Hyrule Field'),
        create_grotto_region('Field Valley Grotto', ['GS Hyrule Field Near Gerudo Valley'], hintName='Hyrule Field'),
        create_grotto_region('Field West Castle Town Grotto', ['Field West Castle Town Grotto Chest'], hintName='Hyrule Field'),
        create_grotto_region('Field Far West Castle Town Grotto', hintName='Hyrule Field'),
        create_grotto_region('Field Kakariko Grotto', ['GS Hyrule Field near Kakariko'], hintName='Hyrule Field'),
        create_grotto_region('Field North Lon Lon Grotto', ['Tektite Grotto Freestanding PoH'], hintName='Hyrule Field'),
        create_grotto_region('Castle Storms Grotto', ['GS Hyrule Castle Grotto'], hintName='Hyrule Castle'),
        create_grotto_region('Kakariko Bombable Grotto', ['Redead Grotto Chest'], hintName='Kakariko Village'),
        create_grotto_region('Kakariko Back Grotto', ['Kakariko Back Grotto Chest'], hintName='Kakariko Village'),
        create_grotto_region('Mountain Bombable Grotto'),
        create_grotto_region('Mountain Storms Grotto', ['Mountain Storms Grotto Chest'], hintName='Death Mountain Trail'),
        create_grotto_region('Top of Crater Grotto', ['Top of Crater Grotto Chest'], hintName='Death Mountain Crater'),
        create_grotto_region('Zora River Plateau Open Grotto', ['Zora River Plateau Open Grotto Chest'], hintName='Zora\'s River'),
...
def create_ow_region(name, locations=None, exits=None, hintName=None):
    return _create_region(name, RegionType.Overworld, locations, exits, hintName)

def create_interior_region(name, locations=None, exits=None, hintName=None):
    return _create_region(name, RegionType.Interior, locations, exits, hintName)

def create_dungeon_region(name, locations=None, exits=None, hintName=None):
    return _create_region(name, RegionType.Dungeon, locations, exits, hintName)

def create_grotto_region(name, locations=None, exits=None, hintName=None):
    return _create_region(name, RegionType.Grotto, locations, exits, hintName)

def _create_region(name, type, locations=None, exits=None, hintName=None):
